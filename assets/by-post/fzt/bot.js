var conversation = [
  ...
  },
  {
    ...
    alts: ["Mi bone fartas kaj vi?"],
    buttons: ["Mi", "kaj", "vi?", "bone", "fartas"],
  },
  {
    user: false,
    sentence: true,
...
$(function () {
  var addNewPart = function (part) {
    ...
    $message
      ...
      .attr(
        "src",
        part.user ? "/assets/by-post/fzt/m1.png" : "/assets/by-post/fzt/f1.png"
      );
  ...
  var addNextPart = function () {
    ...
    currentPart.onInvalidAnswer(function (answer) {
      ...
      $mistake.html(
        "You said: <b>" +
          answer +
          "</b><br />That's not quite right, but give it another shot!"
      );
      $mistake.show();
    });
