...
<script type="text/javascript">
  var books = {
    'good-life': {
      ...
      title: 'A Guide to the Good Life:<br/>The Ancient Art of Stoic Joy',
      rating: '★★★★☆'
    },
    'fluent-forever': {
    ...
    'esperanto-learning-using': {
      ...
      title: 'Esperanto: Learning and Using<br/>the International Language',
      rating: '★★★★★'
    },
    'being-colloquial': {
    ...
    'art-fear': {
      ...
      title: 'Art & Fear: Observations On<br/>the Perils (and Rewards) of Artmaking',
      rating: '★★★★★'
    },
    'fail-at-everything': {
      cover: '/images/books/covers/how-to-fail-at-almost-everything.jpg',
      title: 'How to Fail at Almost Everything<br/>and Still Win Big',
      rating: '★★★☆☆'
    },
    'hegarty-on-creativity': {
      cover: '/images/books/covers/hegarty-on-creativity.jpg',
      title: 'Hegarty on Creativity:<br/>There Are No Rules',
      rating: '★★★★☆'
    },
    'do-the-work': {
    ...
    'win-friends': {
      ...
      title: 'How to Win Friends and<br/>Influence People',
      rating: '★★★★★'
    },
    'stock-operator': {
    ...
    'predictably-irrational': {
      ...
      title: 'Predictably Irrational: The <br/>Hidden Forces That Shape Our Decisions',
      rating: '★★★★★'
    },
    'madness-of-crowds': {
      cover: '/images/books/covers/madness-of-crowds.jpg',
      title: 'Extraordinary Popular Delusions<br/>and the Madness of Crowds',
      rating: '★★★☆☆'
    }
  };
  ...
  for (i = 0; i < $books.length; i++) {
    $books[i].addEventListener('mouseover', function() {
      var bookID = this.getAttribute('href').substring(1)
